...
//   return (
//     <section className="relative min-h-screen overflow-hidden flex items-center bg-primary">
//       {/* Particles */}
//       <Particles
//         id="tsparticles"
//         init={particlesInit}
...
//       <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
//         {/* small tagline */}
//         <p className="text-white text-sm md:text-base font-semibold mb-3 tracking-wide uppercase">
//           Innovating the Future of Finance
//         </p>
...
//             Across Borders Through building relevant consumer-focused fintech
//             solutions.
//           </span>
//         </h1>
...
//           We stand on the shoulders of a giant. A champion of socio-economic
//           prosperity for the people of Africa. From these shoulders, we are
//           able to inspire and transform lives.
//         </p>

//         {/* CTA buttons */}
//         <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
//           <Link to="/products">
//             <Button className="bg-white text-primary hover:bg-white/90 px-6 py-3 rounded-md w-full sm:w-auto">
//               Learn More <ArrowRight className="ml-2 inline-block" />
//             </Button>
//           </Link>
...
//         {/* small feature badges */}
//         <div className="flex flex-wrap justify-center gap-3 mt-10 text-white text-sm">
//           <span className="px-3 py-1 bg-white/10 rounded-full">Fast & Secure</span>
//           <span className="px-3 py-1 bg-white/10 rounded-full">Powering Africa</span>
//           <span className="px-3 py-1 bg-white/10 rounded-full">Enterprise APIs</span>
//           <span className="px-3 py-1 bg-white/10 rounded-full">Trusted</span>
