      ...
      <div className="container mx-auto px-6 lg:px-12 py-24 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-16 leading-relaxed max-w-3xl mx-auto">
            Finserve combines deep knowledge of financial systems and wide-ranging technology experience to deliver innovative, reliable, and high-quality solutions for the financial sector.
          </p>
